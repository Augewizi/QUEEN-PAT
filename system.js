...
const tylorkid1 = fs.readFileSync("./Media/Images/jin1.jpg");
const tylorkid2 = fs.readFileSync("./Media/Images/jin2.jpg");
const tylorkid3 = fs.readFileSync("./Media/Images/jin3.jpg");
const tylorkid4 = fs.readFileSync("./Media/Images/jin4.jpg");
const tylorkid5 = fs.readFileSync("./Media/Images/jin5.jpg");
...
module.exports = Cypher = async (_0x1548f3, _0x50668e, _0x8403a4, _0x1f8e8d) => {
  try {
    ...
    async function _0x383df2(_0x5627fa) {
      const _0x3df8c1 = async _0x222715 => {
        ...
        try {
          ...
          console.error("Error with GiftedTech API:", _0x53f577.message);
          throw _0x53f577;
        }
      };
    ...
    try {
      ...
      console.error("âŒ Error initializing database:", _0x531869);
    }
    ...
    if (_0x50668e.message) {
      lolcatjs.fromString("â”â”â”â”â”â”â”â”â”â”â”â”â”â”ã€Ž ð—”ð——ð—œð—­ð—”-ð—©ðŸ® ã€â”â”â”â”â”â”â”â”â”â”â”â”â”â”€");
    ...
    if (_0x50668e.message) {
      try {
        ...
        console.error("âŒ Error sending presence update:", _0x23a4bf);
      }
    }
    const {
    ...
    if (_0x1a38e3 && db.data.settings.autoreact === "command") {
      ...
      try {
        ...
        console.error("âŒ Error sending reaction:", _0xbf7825);
      }
    }
    ...
    if (_0x50668e.sender !== _0x52b559 && db.data.settings.antidelete === "private" && _0x50668e.message?.protocolMessage?.type === 0 && _0x50668e.message?.protocolMessage?.key) {
      try {
        ...
        let _0xa326d9 = "ðŸš¨ *ð™³ð™´ð™»ð™´ðšƒð™´ð™³ ð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´!* ðŸš¨\n" + readmore + "\nð™²ð™·ð™°ðšƒ: " + _0x2ddfca + "\nðš‚ð™´ð™½ðšƒ ð™±ðšˆ: @" + _0x13e294.split("@")[0] + " \nðšƒð™¸ð™¼ð™´ ðš‚ð™´ð™½ðšƒ: " + _0x586706 + "\nð™³ð™°ðšƒð™´ ðš‚ð™´ð™½ðšƒ: " + _0x4d13ef + "\nð™³ð™´ð™»ð™´ðšƒð™´ð™³ ð™±ðšˆ: @" + _0x73aded.split("@")[0] + "\n\nð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´: " + _0x5f5aad.text;
        let _0x19aef9 = {
          key: {
            remoteJid: _0x107520,
        ...
        console.error("âŒ Error processing deleted message:", _0x148f27);
      }
      ...
      try {
        ...
        let _0x342566 = "ðŸš¨ *ð™³ð™´ð™»ð™´ðšƒð™´ð™³ ð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´!* ðŸš¨\n" + readmore + "\nð™²ð™·ð™°ðšƒ: " + _0x176db7 + "\nðš‚ð™´ð™½ðšƒ ð™±ðšˆ: @" + _0x4ac3f2.split("@")[0] + " \nðšƒð™¸ð™¼ð™´ ðš‚ð™´ð™½ðšƒ: " + _0xb9233d + "\nð™³ð™°ðšƒð™´ ðš‚ð™´ð™½ðšƒ: " + _0x1c5f00 + "\nð™³ð™´ð™»ð™´ðšƒð™´ð™³ ð™±ðšˆ: @" + _0x2d1cc6.split("@")[0] + "\n\nð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´: " + _0x2e34b6.text;
        let _0x1194b6 = {
          key: {
            remoteJid: _0x188294,
        ...
        console.error("âŒ Error processing deleted message:", _0xd889ee);
      }
    }
    if (_0x50668e.sender !== _0x52b559 && !_0x50668e.id.startsWith("3EB0") && db.data.settings.antiedit === "private" && (_0x50668e.message?.protocolMessage?.editedMessage?.conversation || _0x50668e.message?.protocolMessage?.editedMessage?.extendedTextMessage?.text)) {
      try {
        ...
        let _0x5e12fa = "ðŸš¨ *ð™´ð™³ð™¸ðšƒð™´ð™³ ð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´!* ðŸš¨\n" + readmore + "\nð™²ð™·ð™°ðšƒ: " + _0x35a7b6 + "\nðš‚ð™´ð™½ðšƒ ð™±ðšˆ: @" + _0x56c8f9.split("@")[0] + " \nðš‚ð™´ð™½ðšƒ ð™¾ð™½: " + _0x3069fa + "\nð™³ð™°ðšƒð™´ ðš‚ð™´ð™½ðšƒ: " + _0x4f117c + "\nð™´ð™³ð™¸ðšƒð™´ð™³ ð™±ðšˆ: @" + _0x200bd9.split("@")[0] + "\n\nð™¾ðšð™¸ð™¶ð™¸ð™½ð™°ð™» ð™¼ðš‚ð™¶: " + _0x2effe7.text + "\n\nð™´ð™³ð™¸ðšƒð™´ð™³ ðšƒð™¾: " + (_0x50668e.message.protocolMessage?.editedMessage?.conversation || _0x50668e.message.protocolMessage?.editedMessage?.extendedTextMessage?.text);
        let _0x2cf3dd = {
          key: {
            remoteJid: _0x36782b,
        ...
        console.error("âŒ Error processing edited message:", _0x39bee1);
      }
      ...
      try {
        ...
        let _0x98ccbc = "ðŸš¨ *ð™´ð™³ð™¸ðšƒð™´ð™³ ð™¼ð™´ðš‚ðš‚ð™°ð™¶ð™´!* ðŸš¨\n" + readmore + "\nð™²ð™·ð™°ðšƒ: " + _0x244fc9 + "\nðš‚ð™´ð™½ðšƒ ð™±ðšˆ: @" + _0x13a720.split("@")[0] + " \nðš‚ð™´ð™½ðšƒ ð™¾ð™½: " + _0xa23120 + "\nð™³ð™°ðšƒð™´ ðš‚ð™´ð™½ðšƒ: " + _0x153e76 + "\nð™´ð™³ð™¸ðšƒð™´ð™³ ð™±ðšˆ: @" + _0x484dbd.split("@")[0] + "\n\nð™¾ðšð™¸ð™¶ð™¸ð™½ð™°ð™» ð™¼ðš‚ð™¶: " + _0x3d6724.text + "\n\nð™´ð™³ð™¸ðšƒð™´ð™³ ðšƒð™¾: " + (_0x50668e.message.protocolMessage?.editedMessage?.conversation || _0x50668e.message.protocolMessage?.editedMessage?.extendedTextMessage?.text);
        let _0x240293 = {
          key: {
            remoteJid: _0x119160,
        ...
        console.error("âŒ Error processing edited message:", _0x3475a6);
      }
    }
    ...
    if (_0x50668e.quoted && _0x50668e.quoted.viewOnce && (_0x50668e.message?.conversation || _0x50668e.message?.extendedTextMessage) && _0x22e08b && ["ðŸŒš", "ðŸ˜‚", "ðŸ¥²", "ðŸ¤”", "ðŸ¤­", "ðŸ†", "ðŸ¥µ", "ðŸ«‚", "ðŸ˜³"].some(_0xe8b1e7 => _0x50668e.body.startsWith(_0xe8b1e7))) {
      (async () => {
        try {
      ...
      _0x1548f3.sendMessage(_0x50668e.chat, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            serverMessageId: 20,
            newsletterName: "âƒð—”ð——ð—œð—­ð—” ð—•ð—¢ð—§"
          },
          externalAdReply: {
    ...
    switch (_0x1a38e3) {
      case "menu":
        ...
        const _0x4ba61c = (_0x292ced, _0x7fd380, _0x201b3c, _0xa4c7c7, _0x33514f, _0xc3ee53, _0x1746ba) => {
          ...
          const _0x277b6d = (_0x3463fb, _0x43f39d, _0x870af = 10) => {
            let _0x459442 = Math.round(_0x3463fb / _0x43f39d * _0x870af);
            let _0x479819 = "â–ˆ".repeat(_0x459442) + "â–‘".repeat(_0x870af - _0x459442);
            return "[" + _0x479819 + "] " + Math.round(_0x3463fb / _0x43f39d * 100) + "%";
          };
          let _0x25e6ef = 0;
          ...
          let _0x310126 = "â•­â”‰â•¾â–£ â—ˆ *ðŸŒ¹ð—¤ð—¨ð—˜ð—˜ð—¡ð—­ð—¬ðŸŒ¹* â—ˆ\n";
          _0x310126 += "â”Š *á´á´¡É´á´‡Ê€* : " + _0x7fd380 + "\n";
          _0x310126 += "â”‡ *á´˜Ê€á´‡Ò“Éªx* : [ " + _0x201b3c + " ]\n";
          _0x310126 += "â”‡ *Êœá´sá´›* : " + os.platform() + "\n";
          _0x310126 += "â”‡ *á´˜ÊŸá´œÉ¢ÉªÉ´s* : " + _0x25e6ef + "\n";
          _0x310126 += "â”‡ *á´á´á´…á´‡* : " + _0xa4c7c7 + "\n";
          _0x310126 += "â”‡ *á´ á´‡Ê€sÉªá´É´* : " + _0x33514f + "\n";
          _0x310126 += "â”‡ *sá´˜á´‡á´‡á´…* : " + _0xc3ee53.toFixed(4) + " ms\n";
          _0x310126 += "â”‡ *á´œsá´€É¢á´‡* : " + _0x1ecb54(_0x3a3793) + " of " + _0x1ecb54(_0x4497bb) + "\n";
          _0x310126 += "â”‡ *Ê€á´€á´:* " + _0x277b6d(_0x18d668, _0x4497bb) + "\n";
          _0x310126 += "â•°â”‰â”‰â”‰â–£ \n" + _0x1746ba + "\n";
          for (const _0x1daaac in _0x292ced) {
            ...
            _0x292ced[_0x1daaac].forEach(_0x3fd21f => {
              if (_0x3fd21f.command.length > 0) {
                _0x310126 += "â”ŠðŸš€ " + _0x3fd21f.command[0] + "\n";
              }
            });
            _0x310126 += "â•°â”‰â”‰â”‰â–£ \n\n";
          }
        ...
        await _0x50668e.reply("ð™‡ð™¤ð™–ð™™ð™žð™£ð™œ ð˜¼ð™™ð™žð™¯ð™–-ð™«2.4.0...");
